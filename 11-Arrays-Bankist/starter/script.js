...
btnClose.addEventListener("click", function (e) {
  ...
  if (currentAccount.username === inputCloseUsername.value && currentAccount.pin === Number(inputClosePin.value)) {
    ...
    // .indexOf(23) - only in array if it contains true or false
...
//   const arrJDogs = arrJ.slice(1, -2);
//   // const arrJK = [...arrJDogs, ...arrK];
//   const arrJK2 = arrJDogs.concat(arrK);
//   arrJK2.forEach(function (age, i) {
//     const stage = age >= 3 ? "an adult" : "a puppy";
//     age >= 3
//       ? console.log(`Dog number ${i + 1} is ${stage}, and is ${age} years old`)
//       : console.log(`Dog number ${i + 1} is still ${stage}`);
//   });
//   console.log(arrJDogs);
//   // console.log(arrJK);
//   console.log(arrJK2);
// };
...
// const calcAverageHumanAge = function (dogsYearsArr) {
//   const humanAge = dogsYearsArr.map(age => (age <= 2 ? age * 2 : age * 4 + 16));
//   const adultDogs = humanAge.filter(age => age >= 18);
//   const averageAge = adultDogs.reduce((acc, age) => (acc += age), 0) / adultDogs.length;
//   const averageAge2 = adultDogs.reduce((acc, age, i, arr) => (acc += age / arr.length), 0);
...
// const lastLargeMov = movements.findLast(mov => Math.abs(mov) > 2000);
// const lastLMovIndx = movements.findLastIndex(mov => Math.abs(mov) > 2000);
// console.log(`Your latest large movement was ${movements.length - lastLMovIndx} movements ago`);
...
//   breed => breed.activities.includes("running") && breed.activities.includes("fetch")
// ).breed;
...
// // 4.
// const uniqueActObj = [...new Set(allActivities)];
// console.log(uniqueActObj);

// // 5.
// const swimmingBreeds = breeds.filter(breed => breed.activities.includes("swimming"));
// const swimmingAdjacent = [
//   ...new Set(swimmingBreeds.flatMap(breed => breed.activities).filter(act => act !== "swimming")),
// ];
...
// // BONUS
// const fetchBreed = breeds.filter(breed => breed.activities.includes("fetch"));
// const averageWeightFetch = Math.max(...fetchBreed.map(breed => breed.averageWeight));
// console.log(averageWeightFetch);
...
// const randomDiceRolls = Array.from({ length: 100 }, (_, i) => Math.trunc(Math.random() * 10));
...
// // My Bonus
// const numAccDep1000 = accounts
//   .map(acc => acc.movements.reduce((sum, cur) => sum + cur))
//   .filter(sum => sum >= 1000).length;
// console.log(numAccDep1000);
...
// //  Task 8.
// const groupedDogsEat = Object.groupBy(dogs, dog => {
//   if (dog.curFood < dog.recFood * 1.1 && dog.curFood > dog.recFood * 0.9) return "exact";
//   if (dog.curFood > dog.recFood * 1.1) return "too-much";
//   if (dog.curFood < dog.recFood * 0.9) return "too-little";
// });
// console.log(groupedDogsEat);

// // Task 9.
// const groupedDogsOwn = Object.groupBy(dogs, dog => dog.owners.length);
// console.log(groupedDogsOwn);
